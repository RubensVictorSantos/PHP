...
<body>
	...
	<main class="main-content" id="caixa_conteudo">
			...
			<section class="container-cadastro">
				...
				<form name="frmCadastro" class="form-inputs-field" method="post" action="index.php">
					<div class="form-inputs-field">
						...
						<!-- Input txt_telefone -->
						<div class="field-input">
							<input type="tel" id="txt_telefone" name="txttelefone" pattern="[0-9]{2}[0-9]{4}[0-9]{4}" onkeypress="" value="<?php echo ($telefone) ?>" required />
						...
						<div class="field-input">
							<label class=""><span>Obs</span></label>
			...
			<section class="container-consulta">
				...
				<div class="tb-container default-scroll">
